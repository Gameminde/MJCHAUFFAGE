              ...
              <div className="flex items-center justify-center h-16 border-b border-neutral-200">
                {isOpen || typeof window !== 'undefined' && window.innerWidth < 1024 ? ( // Show full logo on mobile open or desktop open
                  <div className="flex items-center space-x-2">
                    ...
                    <span className={`text-xl font-bold text-neutral-900 ${!isOpen && 'lg:hidden'}`}>CHAUFFAGE</span>
                  </div>
                ) : (
                  <div className="w-8 h-8 bg-primary-600 rounded-lg flex items-center justify-center">
                    <span className="text-white font-bold">MJ</span>
                  ...
                  {menuItems.map((item) => (
                    ...
                    >
                      ...
                      {(isOpen || typeof window !== 'undefined' && window.innerWidth < 1024) && ( // Always show text on mobile drawer
                        <>
                          <span className={`ml-3 flex-1 text-left ${!isOpen && 'lg:hidden'}`}>{item.label}</span>
                          {item.badge && (
                            <span className={`ml-2 inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${item.badgeColor || 'bg-primary-100 text-primary-800'
                              } ${!isOpen && 'lg:hidden'}`}>
                              {item.badge}
                            </span>
                          )}
