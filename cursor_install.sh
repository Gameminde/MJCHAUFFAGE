...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2025.10.13-405ee2e-$(date +%s)"
...
DOWNLOAD_URL="https://downloads.cursor.com/lab/2025.10.13-405ee2e/${OS}/${ARCH}/agent-cli-package.tar.gz"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2025.10.13-405ee2e"
rm -rf "${FINAL_DIR}"
...
ln -s ~/.local/share/cursor-agent/versions/2025.10.13-405ee2e/cursor-agent ~/.local/bin/cursor-agent
